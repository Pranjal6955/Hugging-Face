...
import { Github, Twitter, UserPlus, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <p className="mt-2 text-sm text-secondary-600 dark:text-secondary-300">
            ...
            <Link to="/login" className="font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400">
              Sign in
            </Link>
          </p>
        </motion.div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <Button
                ...
                variant="primary"
                loading={isLoading}
                icon={!isLoading ? <UserPlus className="mr-2 h-5 w-5" /> : undefined}
              >
                Create account
              </Button>
            </div>
